...
const ChatThemePage = () => {
  ...
  const handleThemeSelect = (theme: ThemePreset) => {
    setFormValues({
      ...
      bg_image: null,
      user_text_color: theme.type === "dark" ? "#FFFFFF" : "#000000",
      contact_text_color: theme.type === "dark" ? "#FFFFFF" : "#000000",
    });
    setBgType("color");
  ...
  const handleSave = async () => {
    try {
      ...
      toast.success(t("chat_theme.save_success") || "Theme saved successfully!");
    } catch (error: any) {
