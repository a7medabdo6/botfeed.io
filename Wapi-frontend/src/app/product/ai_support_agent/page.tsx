    ...
    <ProductLayout>
      <ProductPageTemplate
        hero={{
          ...
          secondaryCTA: { text: "Book a Demo", link: "/default_action" },
          image: HomeImg,
        }}
        features={[
          {
        ...
        finalCTA={{
          ...
          description: "Businesses using Botfeed AI reduce support ticket volume by over 65% in the first month.",
