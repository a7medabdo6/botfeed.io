    ...
    <ProductLayout>
      <ProductPageTemplate
        hero={{
          ...
          primaryCTA: { text: "Manage Campaigns", link: "/campaigns" },
        ...
        finalCTA={{
          ...
          description: "Botfeed Broadcasts achieve up to 98% open rates compared to traditional email marketing.",
