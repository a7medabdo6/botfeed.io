            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-2">
                {connectionMethods.map((method) => (
                  <div key={method.label} className={`h-18 min-w-25 flex-1 flex flex-col items-center justify-center text-center px-2 py-2 rounded-lg border border-slate-100 dark:border-none dark:bg-(--card-color) ${method.bg} transition-transform hover:scale-105`}>
