...
export default function FlowList() {
  ...
  const [toggleFlow, { isLoading: isStatusToggling }] = useToggleAutomationFlowMutation();
  ...
  return (
    <div className="sm:p-8 p-4 space-y-8">
      <CommonHeader title="Flow Builder" description="Manage your WhatsApp bot automation flows" onSearch={handleSearch} searchTerm={inputValue} searchPlaceholder="Search flows..." featureKey="template_bots_used" onRefresh={handleRefresh} onAddClick={onAddClick} addLabel="Create New Flow" addPermission="create.automation_flows" deletePermission="delete.automation_flows" isLoading={isLoading} columns={visibleColumns} onColumnToggle={handleColumnToggle} onBulkDelete={handleBulkDelete} selectedCount={selectedIds.length} />
