...
const TemplateMessage: React.FC<TemplateMessageProps> = ({ message, isWindowExpired }) => {
    ...
    <BaseMessage message={message} isWindowExpired={isWindowExpired}>
      <div className="flex flex-col -mx-3 -my-1.5 mb-1.5 min-w-64 max-w-70 sm:max-w-xs">
        ...
        {!isCarouselProduct && !isCarouselMedia && template.buttons && template.buttons.length > 0 && (
          <div className="border-t border-slate-100 dark:border-(--card-border-color) mt-1 divide-y divide-slate-100 dark:divide-slate-800">
