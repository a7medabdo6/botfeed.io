      ...
      <div id={`message-${message.id}`} className={cn("group/bubble flex w-full mb-0.5 px-4", isOutgoing ? "justify-end" : "justify-start")}>
        <div className={cn("relative max-w-[85%] sm:max-w-[70%] lg:max-w-[60%] group flex flex-col", isOutgoing ? "items-end" : "items-start")}>
          ...
          <div className="relative flex items-start">
            <div className={cn("absolute z-10 whitespace-nowrap transition-all duration-300", "sm:top-1/2 sm:-translate-y-1/2", isOutgoing ? "sm:right-full sm:mr-3" : "sm:left-full sm:ml-3", "-top-5 flex items-center gap-1 sm:flex-row", isOutgoing ? "right-0 flex-row" : "left-0 flex-row-reverse")}>
