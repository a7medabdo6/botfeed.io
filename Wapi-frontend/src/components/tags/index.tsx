...
const TagsPage = () => {
  ...
  return (
    <div className="sm:p-8 p-4 space-y-8">
      <CommonHeader title="Tags" description="Organize your contacts and conversations with custom labels" onSearch={handleSearch} searchTerm={inputValue} featureKey="tags_used" searchPlaceholder="Search tags..." onRefresh={handleRefresh} onAddClick={onAddClick} addLabel="Create New Tag" addPermission="create.tags" deletePermission="delete.tags" isLoading={isLoading} columns={visibleColumns} onColumnToggle={handleColumnToggle} onBulkDelete={handleBulkDelete} selectedCount={selectedIds.length} />
