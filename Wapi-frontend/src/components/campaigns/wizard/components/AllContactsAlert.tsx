...
export const AllContactsAlert = ({ count }: AllContactsAlertProps) => {
  return (
    <div className="sm:p-8 p-4 rounded-lg bg-primary/5 dark:bg-(--dark-sidebar) flex-col sm:flex-row border border-[#00aeef57] dark:border-none flex items-center gap-6">
