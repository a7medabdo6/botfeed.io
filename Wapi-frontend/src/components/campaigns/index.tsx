...
import { AlertCircle, Calendar, CheckCircle2, Clock, FileDown, Info, Loader2 } from "lucide-react";
      ...
      cell: (row) => (
        <div className="flex justify-end gap-2">
          ...
          <Button
            variant="outline"
            size="sm"
            className="h-8 w-8 p-0 rounded-lg bg-gray-50 text-gray-500 hover:text-primary dark:bg-transparent dark:border-none border-gray-100 transition-all disabled:opacity-30"
            onClick={() => {
  ...
  const handleExport = (type: "csv" | "excel" | "print") => {
    ...
    const rowData = [
      [
        ...
        campaignAction.sent_at ? formatDate(campaignAction.sent_at) : "-",
      ],
    ];
