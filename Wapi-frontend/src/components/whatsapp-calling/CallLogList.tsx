...
const CallLogList = () => {
  ...
  return (
    <div className="p-4 sm:p-6 space-y-8 animate-in fade-in duration-500">
      <CommonHeader backBtn title="Call Logs" description="Review recording history and AI transcriptions for your WhatsApp voice calls." onSearch={setSearchTerm} searchTerm={searchTerm} onRefresh={refetch} isLoading={isLoading} />
