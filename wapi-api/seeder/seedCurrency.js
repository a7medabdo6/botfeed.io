...
async function seedCurrency() {
  try {
    const currencies = [
      { name: 'US Dollar', code: 'USD', symbol: '$', exchange_rate: 1, decimal_number: 2, sort_order: 1, is_active: true },
      { name: 'Euro', code: 'EUR', symbol: '€', exchange_rate: 0.92, decimal_number: 2, sort_order: 2, is_active: true },
      { name: 'British Pound', code: 'GBP', symbol: '£', exchange_rate: 0.79, decimal_number: 2, sort_order: 3, is_active: true },
      { name: 'Indian Rupee', code: 'INR', symbol: '₹', exchange_rate: 83.0, decimal_number: 2, sort_order: 4, is_active: true },
