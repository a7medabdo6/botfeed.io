import { Subscription, AiPromptLog, Plan, PaymentHistory, User, Tag, Contact, Template, Campaign, CustomField, AutomationFlow, Team, Setting, Message } from '../models/index.js';
...
const fetchDynamicUsage = async (userId) => {
    const [tagsCount, contactsCount, templatesCount, campaignsCount, customFieldsCount, staffCount, botFlowsCount, aiPromptCount, messagesCount, teamCount] = await Promise.all([
