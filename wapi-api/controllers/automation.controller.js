  ...
  try {
    const nodeTypes = [
      ...
      },
      {
        ...
        outputs: 1,
        parameters: [
          { name: 'message_template', type: 'textarea', label: 'Body' },
          { name: 'button_params', type: 'object', label: 'Buttons' }
        ]
      },
      {
        id: 'send_template',
        name: 'Send Template',
        description: 'Send an approved WhatsApp template by ID',
        category: 'action',
        icon: 'message',
        inputs: 1,
        outputs: 1,
        parameters: [
          { name: 'template_id', type: 'text', label: 'Template ID' }
        ]
      },
      {
        id: 'call_to_action',
        name: 'Call to Action',
        description: 'Interactive CTA URL button',
        category: 'action',
        icon: 'message',
        inputs: 1,
        outputs: 1,
        parameters: [
          { name: 'message_template', type: 'textarea', label: 'Body' },
          { name: 'cta_url_params', type: 'object', label: 'CTA (display_text, url)' }
        ]
      },
      {
        id: 'webhook',
