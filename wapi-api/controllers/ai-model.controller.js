...
const PROVIDERS = ["openai", "anthropic", "google", "groq", "mistral", "openrouter", "deepseek", "xai", "cohere"];
...
export const testModelApi = async (req, res) => {
  try {
    ...
    const result = await testAIModel(cleanModel, prompt, apiKey, req.user?._id || req.user?.id);
